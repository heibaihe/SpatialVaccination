...
double hf[K]; // factors for the infection rate for the regions 
...
factor=pow(10,0.1); // step for mu in computation, 0.1 orders of magnitude
    ...
    // vaccination from regions with low infection rate
    hf[0]=1;
	hf[1]=2;
	hf[2]=3;
	hf[3]=4;
    ...
    // vaccination from regions with high infection rate
  /*hf[0]=10;
	hf[1]=9;
	hf[2]=8;
	hf[3]=7;
