...
double Vmax; // vaccination rate (population fraction per year)
...
int main(){
	...
	v=1.0*4/365; // vaccination rate per infection cycle
...
for(Vmax=1.0;Vmax>=0.5;Vmax=Vmax-0.01)   // loop for the vaccination population
{ 
...
fprintf(fp1,"%f  %f\n",1-Vmax,count2/(double)Realizations);	
//mu=mu*factor;
}
